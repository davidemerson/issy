class Issy < Formula
  ...
  url "https://github.com/davidemerson/issy/archive/refs/tags/v1.2.3.tar.gz"
  sha256 "42276675a99c9b76898dc5342d909efc617611c8d3277ab72db7eb2b1f2944fe"
  ...
  def stable_commit
    "33881d5ce64cecad9356b8e1e15219be142b60b9"
  end
  # STABLE_END
